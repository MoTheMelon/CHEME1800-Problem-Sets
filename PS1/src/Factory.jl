...
function build(type::Type{DNAEncryptionKey})::DNAEncryptionKey
    ...
    #initialize an instance of DNAEncryptionKey
    key = DNAEncryptionKey();

    #create a dictionary to assign every possible character to an encryption
